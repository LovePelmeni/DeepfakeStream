...
DeepfakeStream is a web service for recognizing and spotting deepfakes on images and videos, artificially generated by Generative and Adversarial networks.
